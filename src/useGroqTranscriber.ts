...
export default function useGroqTranscriber({aiUsage, onUpdate, onComplete, onReady, onStart, onError}): Transcriber {
	...
	function feed(data) {
		//console.log('FEED groqstt',data)
	}
	
	function start(data, duration) {
		setIsBusy(true)
		if (onStart) onStart()
		//console.log('START groqstt',data)
