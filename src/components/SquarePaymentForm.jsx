...
export default function SquarePaymentForm ({login, user, token, exchangeRate, updateCreditBalance}) {
    ...
    if (!(token && token.access_token)) {
        ...
        <h3>Buy Credit</h3>
        <div style={{marginBottom:'1em'}}>You need to <Button onClick={login} >Login</Button> before you can buy credit.</div>
        </div>
    } else {
        ...
        return  <div>
            ...
            <h3>Buy Credit</h3>
            <div style={{marginBottom:'1em'}}>Purchasing credit gives you quick and easy access to a wide range of language models from various providers as well as our other useful endpoints to help power your Personas.</div>
            ...
            {(!isComplete && amount > 0) && <div>
                ...
                <Form style={{paddingTop:'1em',borderTop:'2px solid black'}}>
                    ...
                    <Form.Label style={{marginRight:'1em'}}>Payment Details</Form.Label>
                <PaymentForm
                /**
