...
import { webmFixDuration } from "./BlobFix.ts";
...
export default function AudioRecorder({onRecordingComplete, hotwordManager}) {
    ...
    const startRecording = async () => {
		...
		if (hotwordManager) hotwordManager.stop()
    ...
    const stopRecording = () => {
        if (
            ...
            setDuration(0);
            setRecording(false);
            if (hotwordManager) hotwordManager.start()
        }
    };
