...
import StarredRoleAndTeamList from '../components/StarredRoleAndTeamList'
export default function RolesPage(props) {
	...
	return	<div className="App" id={refreshHash} >
		{<>
			...
			<span style={{float:'right'}}>	 
				<Button style={{float:'right', marginLeft:'1em'}} variant="primary" onClick={exportRoles} >{icons.export}<span className="d-none d-md-inline" > Export</span></Button>
				<span style={{float:'right'}} >
					...
					{icons.import}<span className="d-none d-md-inline" > Import</span>
					</Button>
				</span>
			</span>
    ...
    >
	  ...
	  <StarredRoleAndTeamList {...props}   forceRefresh={forceRefresh}  />
        
      </Tab><Tab eventKey="roles" title="Personas">
