...
export default function TeamPage(props) {
	...
	const {creditBalance, aiUsage, teams, setTeams,roles,  icons, utils, chatHistoryTeams, setChatHistoryTeams, currentTeam, setCurrentTeam, forceRefresh, playSpeech, categories, setCategories, refreshHash, user, token, login, logout, config, chatHistoryId} = props
